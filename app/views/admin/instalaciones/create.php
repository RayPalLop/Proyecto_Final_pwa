...
/**
 * Archivo: create.php
 * Ubicación: /app/views/admin/instalaciones/create.php
 * Descripción: Vista para mostrar el formulario de creación de una nueva instalación.
 * Esta vista es incluida por InstalacionesController::create().
 */
...
// $errors and $success_message are expected from the controller.
...
<div class="container-fluid">
    <h1 class="mt-4">Añadir Nueva Instalación</h1>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="instalaciones.php?action=create" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tipo" name="tipo" value="<?php echo htmlspecialchars($tipo ?? ''); ?>" placeholder="Ej: Sala, Piscina, Estudio" required>
                </div>
                <div class="mb-3">
                    <label for="capacidad" class="form-label">Capacidad</label>
                    <input type="number" class="form-control" id="capacidad" name="capacidad" value="<?php echo htmlspecialchars($capacidad ?? ''); ?>" min="1" required>
                </div>
                <div class="mb-3">
